...
const JOURNEY_CASES = [
  ...
  // 다섯째 배지까지 (같은 지시서 §5.3)
  '37', '38', '39', '40',
  // 여섯째·일곱째 배지까지 (지시서 `docs/orders/JOURNEY_BADGE67_20260924.md` §8.1)
...
export const SUITES = {
  ...
  journey: {
    ...
    // **9다** (2026-09-24 · `docs/orders/JOURNEY_BADGE67_20260924.md`). 줄 열여섯(㊶~56)이
    // 늘었고 ⑬⑭⑮가 **선단 체육관에서** 재는 것으로 뜻이 바뀌었다. **8로 잰 판은 못 보탠다**
    contract: 9,
