...
| 자산 | 44그룹 · 파일 11,251개 · 1002.7MB — **포켓몬 3D 672.8**(파일 3,933) · **NPC 모델 147.2**(116벌) · **배틀 무대 128.2**(30벌) · 청크 28.4 · 소리 7.5 · 대사 3.7 · 행렬 3.4 · 소품 2.8 · 주인공 1.5MB (전부 PNG, KTX2 0개). 설치가 **요구하는** 것은 그중 26그룹이다 (DEPLOY.md §5.3 ⑮) |
