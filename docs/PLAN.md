...
| 자산 | 파일 7,085개 · 658.7MB — **포켓몬 3D 422.7**(493종) · **배틀 무대 134.4**(30벌) · NPC 모델 43.6 · 청크 29.8 · 소리 7.9 · 주인공 5.1 · 행렬 3.5 · 대사 3.5MB (전부 PNG, KTX2 0개) |
...
타일 거동값 32종이 아직 안 갈렸다(전 오버월드의 1.3%) · KTX2 0개.
...
- **스윕(`0xE3`).** 204회고 나머지 모듈레이션은 붙었다 (§16.8).
