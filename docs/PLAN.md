...
| 자산 | 44그룹 · 파일 11,251개 · 1002.6MB — **포켓몬 3D 672.8**(파일 3,933) · **NPC 모델 147.1**(116벌) · **배틀 무대 128.2**(30벌) · 청크 28.4 · 소리 7.5 · 대사 3.7 · 행렬 3.4 · 소품 2.8 · 주인공 1.5MB (전부 PNG, KTX2 0개). 설치가 **요구하는** 것은 그중 26그룹이다 (DEPLOY.md §5.3 ⑮) |
...
| **모델이 서는 배치** | **1,895개 (53.3%)** — 사람 그림만 보면 **100%** · 116벌 147.1MiB |
...
실측 **116벌에 147.1MiB**다. 106벌로 잰 자리에서 클립을 하나도 안 실으면
