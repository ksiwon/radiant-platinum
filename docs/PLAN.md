...
| | 실측 |
|---|---|
| 코드 | 194,298줄 · 파일 905개 · 시험 파일 306개 (`src/**/*.ts{,x}`) / 시험 **3,889개** (`pnpm test:strict` · 건너뛴 것 3개 — 시험 파일 312개 중 여섯은 `tools/`에 있다) |
...
| 자산 | 45그룹 · 파일 11,255개 · 1064.7MB — **포켓몬 3D 705.5**(파일 3,933) · **NPC 모델 167.5**(116벌 + 목차) · **배틀 무대 134.5**(30벌) · 청크 29.8 · 소리 7.9 · 대사 3.9 · 행렬 3.5 · 소품 3.0 · 주인공 1.6MB (전부 PNG, KTX2 0개). 설치가 **요구하는** 것은 그중 28그룹이다 — Platinum 스물넷 · BDSP 넷 (`import/install/required.ts` · DEPLOY.md §5.3 ⑮) |
