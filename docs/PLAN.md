...
시험은 **소스 옆에 둔다**(`*.test.ts`, 109파일 / 1,271개). 따로 `tests/`를 두지
...
| 자산 | 파일 7,086개 · 630.1MB — **포켓몬 3D 404.5**(493종) · **배틀 무대 128.2**(30벌) · NPC 모델 41.6 · 청크 28.4 · 소리 7.5 · 주인공 4.8 · 행렬 3.4 · 대사 3.3 · 자전거 0.6MB (전부 PNG, KTX2 0개) |
...
| | 크기 | 다음에 할 일 |
|---|---|---|
| 긴 풀(0x03)이 짧은 풀과 같은 포기다 | 1,066칸 | 원작은 사람 위에 **판을 덧그린다**(`ov5_021F3844`, fldeff 89). 그 그림과 보통 풀 흔들림 그림의 칠해진 높이를 견주면 배수가 나온다 |
