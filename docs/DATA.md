...
5. **팔 마디를 `세로배율 ÷ 굵기배율`만큼 늘인다** (`ARM_ROOT`). ⚠️ **③이 가로로
   뻗은 것을 짧게 만든다** — 다리는 세로라 키 늘림을 그대로 받는데 팔은 T자세에서
   누워 있어 굵기만 받는다. 배율이 아니라 **마디 위치**를 옮기는 것이라 팔꿈치가
   굽어도 안 틀어지고, 손에서 멈춰 손가락은 안 늘인다.
...
| | 키 | 머리 높이 | 허벅지 폭 | 발 길이 | 어깨~손 |
|---|---:|---:|---:|---:|---:|
| 광휘 (등신) | 1.564 | 21.4% | 11.3% | 18.1% | 30.0% |
| 리오 (등신) | 1.749 | 16.0% | 8.2% | 14.0% | 33.1% |
| 신사 (등신) | 1.788 | 20.7% | 9.3% | 16.2% | — |
| 핸섬 (치비) | 1.745 | 15.2% | 10.4% | 17.3% | 32.4% |
| 엄마 (치비) | 1.785 | 22.5% | 7.8% | 15.8% | 31.9% |
| 마박사 (치비) | 1.781 | 21.2% | 9.4% | 14.9% | 31.9% |

네 자리 모두 등신 셋이 만드는 폭 안에 든다.
