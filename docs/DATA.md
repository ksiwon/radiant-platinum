...
| 트레이너 | `poketool/trainer/trdata` + `trpoke` | ⬜ 미착수 (각 928개) |
...
| `names/*.json` (3로케일) | 60KB | 20KB |

**신오 전체가 압축 후 160KB 남짓이다.** 전부 정적 JSON·바이너리이고 런타임에 롬을 파싱하지 않는다.
...
| 트레이너 (`trdata`/`trpoke`) | 각 928 | 전투 시스템과 함께 다루는 편이 낫다 |
