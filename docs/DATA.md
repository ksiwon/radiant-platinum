...
| 대사 | `msgdata/pl_msg.narc` | ✅ 뱅크 467개 — 미국 685개가 디컴프 원문과 완전 일치 (§2.11) |
...
| **파열된 세계** | `fielddata/tornworld/tw_arc{,_attr}.narc` | ✅ 맵 10 · 떠 있는 판 10 · 통행 격자 12벌 · 사건 45자리 (§2.22) |
...
"몇 개를 만들었나"(270/840)는 눈금이 못 된다. 안 쓰이는 명령이 태반이라서다.
...
### 2.22 tw_arc — 파열된 세계는 맵 격자가 아니라 **떠 있는 판**이다
