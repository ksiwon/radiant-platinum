...
이렇게 이어서 배치 3,555개 중 **1,508개(42.4%)**가 모델로 선다. 남은 것 중 제일
큰 것들은 사람이 아니다(`ROCK_SMASH` 591 · `POKEBALL` 331 · 열매밭 118 ·
환풍구 65 · 괴력바위 50 · 베어야 할 나무 49). 사람인데 아직 못 세우는 것은
포켓몬센터 2층 안내원(101) · 상점 점원(48) · 접수원(25) · 노인(27) · 마박사(15) ·
헨들러(12) 같은, **트레이너가 아니라 갈래가 없는 사람들**이다.

⚠️ **그런데 그 이름표가 이미 이 파일에 있다.** BDSP는 그들을 필드 번들에만 두는데
`fc2###` 42벌의 이름표가 `reception01`·`clerk`·`grandpa`·`grandmother01`처럼
붙어 있다 — 없는 것은 자산이 아니라 **플래티넘 그림 이름과 잇는 대응표**다.
지금 구운 것은 셋뿐이다(`fc2013`·`fc2032`·`fc2033_01`). 이름표가 안 붙은 번들은
둘이고(`fc2039_00`·`fc2044_00`, 텍스처가 `wear`·`face`뿐이다) 마박사만 아직
어느 번들인지 못 짚었다.
