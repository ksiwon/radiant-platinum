...
"몇 개를 만들었나"(356/840)는 눈금이 못 된다. 안 쓰이는 명령이 태반이라서다.
...
헨들러(12) 같은, **트레이너가 아니라 갈래가 없는 사람들**이다. BDSP는 그들을
필드 번들에만 두고 이름표도 다르게 붙여 놓아서, 지금 자료로는 「이 사람이 저
사람이다」를 못 댄다.
