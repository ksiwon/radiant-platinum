...
| | 초반 | 중반 | 후반 |
|---|---|---|---|
| 원작대로 | 7.2초 | 10.3초 | 13.7초 |
| **빠르게** (기본) | 3.1초 | 4.5초 | 6.0초 |
| 아주 빠르게 | 1.6초 | 2.3초 | 3.1초 |
...
되재 보면 한 턴이 **원작대로에서 7.23초**로 위 표의 첫 줄과 맞는다. 같은 턴에서
글이 화면에 머무는 시간은 이렇다:

| | 원작대로 | 빠르게(기본) | 아주 빠르게 |
|---|---:|---:|---:|
| 「○○의 몸통박치기!」 | 1,967ms | 983ms | 500ms |
| 「효과가 굉장했다!」 | 1,100ms | 550ms | 283ms |
| 한 턴 | 7.23초 | 3.62초 | 1.85초 |
