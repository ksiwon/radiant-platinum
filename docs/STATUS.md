...
| 알고 남겨 둔 것 | 8 | [PLAN.md](PLAN.md) §16.10 |
...
| §9 | 컷신이 도는 것만 보고 무엇이 나오는지는 아무도 안 본다 | 중간 | 1 |
