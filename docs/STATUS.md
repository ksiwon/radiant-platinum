...
| 우리가 만든 자리가 어긋난 것 | 13 | [REPAIR.md](REPAIR.md) |
...
| §8.8 | 인물 3D | GLB 114벌이 배치의 52.9%(3,555 중 1,879)에 선다. ⚠️ 사람 그림만 보면 99.2%다 — 남은 1,676개 중 사람은 열여섯(핸섬·플루토, BDSP에 몸이 없다)뿐이고 나머지는 바위·볼·문 같은 물건이거나 포켓몬이다 (3D_GAP_AUDIT §3. |
