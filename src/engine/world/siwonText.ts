...
export interface SiwonLines {
  ...
  /** 앞의 것을 아직 안 썼다. 차례가 `SIWON_GIFTS`와 같고 마지막은 없다 */
...
const KO: SiwonLines = {
  ...
  gift: [
    '먼저 이것부터.\n'
    + '기라 건물의 잠긴 문을 여는 열쇠야.\r'
    + '로토무를 데려가서 가전에 넣어 봐.\n'
    + '아직 로토무가 없다면 무궁저택이야. 밤에.',
    '신월도로 가는 배는 이게 있어야 타.\n'
    + '운하시티 여관에서 물어봐.\r'
...
const EN: SiwonLines = {
  ...
  gift: [
    ...
    + 'It only carries at the Spear Pillar.\r'
